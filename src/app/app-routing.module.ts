...
import { CreateLensesComponent } from './_Components/create-lenses/create-lenses.component';
...
import { LensesListComponent } from './_Components/lenses-list/lenses-list.component';
...
import { CreatePaymentComponent } from './_Components/create-payment/create-payment.component';
...
const routes: Routes = [
  ...
  {path:'login',component:LoginComponent},
   ...
   {path:'lenses',component:LensesListComponent},
   {path:'create-lenses',component:CreateLensesComponent},
